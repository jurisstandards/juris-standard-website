...
import { CheckCircle2, MapPin, Building2, Zap, ShieldCheck, QrCode, Globe, ArrowRight } from "lucide-react";
import Link from "next/link";

const mockProfile = {
  name: "LexTech AI Solutions",
  headquarters: "Singapore",
  citation: "Recognised for pioneering advanced artificial intelligence frameworks that significantly enhance the accuracy and efficiency of complex multijurisdictional legal research.",
  overview: "LexTech AI Solutions is a premier legal technology enterprise dedicated to transforming the operational capabilities of global law firms and corporate legal departments. By leveraging proprietary machine learning models, LexTech has established itself as an institutional leader in the legal intelligence sector.",
  innovationDomains: ["Artificial Intelligence for Legal", "Legal Research & Knowledge"],
  coreProducts: ["LexTech Search Engine", "Contract Analyzer Pro", "Regulatory Compliance Scanner"],
  marketsServed: ["Law Firms", "Corporate Legal Departments", "Judiciary"],
  timeline: [
    { year: "2024", title: "Legal Innovation Excellence™", detail: "Recognised" },
  ],
  verificationId: "LIE-2024-LTX91"
};

export default function LegalInnovationProfilePage({ params }: { params: { id: string } }) {
  return (
    <main className="min-h-screen bg-[#000000] selection:bg-[#C5A059]/30 flex flex-col font-sans text-[#FFFFF0]">
      ...
      <section className="w-full pt-40 pb-24 border-b border-[#222222] bg-[#000000]">
        <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-4 text-xs font-semibold tracking-widest text-[#C5A059] uppercase mb-12">
            ...
            LEGAL INNOVATION EXCELLENCE™ • OFFICIAL RECORD
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-16 lg:gap-24 items-start">
            ...
            <div className="w-48 h-64 bg-[#111111] border border-[#222222] shrink-0 flex items-center justify-center relative">
               <Globe className="w-20 h-20 text-[#333333]" strokeWidth={1} />
            ...
            <div className="flex flex-col flex-grow">
              ...
              <div className="flex flex-col gap-4 text-sm tracking-widest uppercase text-[#FFFFF0]/60 mb-12">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#C5A059] font-semibold">Headquarters: {mockProfile.headquarters}</span>
                </div>
              </div>
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[1200px] mx-auto py-24 grid grid-cols-1 lg:grid-cols-3 gap-24">
        ...
        <div className="lg:col-span-2 flex flex-col gap-24">
          ...
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C5A059] mb-8">Organisation Overview</h3>
          ...
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C5A059] mb-8">Innovation Domains</h3>
            <div className="flex flex-wrap gap-4">
              {mockProfile.innovationDomains.map(domain => (
          ...
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C5A059] mb-8">Core Products & Solutions</h3>
            <ul className="flex flex-col gap-4">
              {mockProfile.coreProducts.map((product, idx) => (
                <li key={idx} className="text-sm text-[#FFFFF0]/70 font-light tracking-wide flex items-center gap-3">
                  <Zap className="w-3 h-3 text-[#C5A059]/50" /> {product}
                </li>
              ))}
            </ul>
          </section>
        ...
        <div className="flex flex-col gap-16">
          ...
          {/* Markets Served Block */}
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C5A059] mb-6">Markets Served</h3>
            <ul className="flex flex-col gap-4">
              {mockProfile.marketsServed.map((market, idx) => (
                <li key={idx} className="text-sm text-[#FFFFF0]/70 font-light tracking-wide flex items-center gap-3">
                  <Building2 className="w-3 h-3 text-[#C5A059]/50" /> {market}
                </li>
              ))}
            </ul>
          </section>
          ...
          <section className="p-8 bg-[#111111] border border-[#333333]">
            ...
            <p className="text-[0.65rem] uppercase tracking-widest text-[#FFFFF0]/50 leading-loose mb-8">
              Official assets and downloads are strictly available to recognised organisations via the Recognition Centre.
            </p>
