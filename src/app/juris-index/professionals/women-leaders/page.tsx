...
import { ArrowRight, Search, Briefcase, Calendar, ShieldCheck, Award, Building2, MapPin, Star } from "lucide-react";
import Link from "next/link";

export default function WomenLeadersPortalPage() {
  return (
    <main className="min-h-screen bg-[#000000] selection:bg-[#C5A059]/30 flex flex-col font-sans text-[#FFFFF0]">
      ...
      <section className="relative w-full pt-40 pb-32 border-b border-[#222222] bg-[#000000]">
        <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[2000px] mx-auto flex flex-col lg:flex-row justify-between items-start gap-24">
          ...
          <div className="max-w-3xl">
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-[#FFFFF0] leading-[1.05] tracking-wide mb-8 font-light uppercase">
              WOMEN LEADERS <br/>
              <span className="font-medium text-[#C5A059]">
                IN LAW<sup className="text-[0.4em] ml-2">™</sup>
              </span>
            </h1>
            ...
            <div className="p-8 bg-[#111111] border border-[#222222] mb-12">
              ...
              <p className="text-sm text-[#FFFFF0]/80 font-light leading-relaxed mb-6">
                "Women Leaders in Law™ is an institutional recognition of leadership and influence, not simply participation. This index celebrates professional excellence, impact on clients, mentoring, innovation, and integrity, conferring long-term prestige upon the remarkable women shaping the global legal profession."
              </p>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center bg-[#111111] border border-[#333333] p-1 w-full max-w-xl">
                ...
                <input 
                  type="text" 
                  placeholder="Search by Leader, Role, or Domain"
          ...
          <div className="w-full lg:w-[400px] shrink-0">
             <div className="bg-[#111111] border border-[#222222] p-10 flex flex-col relative">
               ...
               <p className="text-xs text-[#FFFFF0]/60 leading-relaxed mb-8">
                 Verify the official status and standing of any leader recognised within the Women Leaders in Law™ index.
               </p>
      ...
      <section className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[2000px] mx-auto py-32 bg-[#000000]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Collection 1 */}
          <Link href="/juris-index/professionals/women-leaders/directory" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             <Search className="w-10 h-10 text-[#C5A059] mb-8" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Recognised Leaders</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               The official annual record of all women recognised under Women Leaders in Law™.
             </p>
          ...
          <div className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Leadership Domains</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-4">
               The primary method to browse recognised leaders by their sphere of influence.
             </p>
             <div className="flex flex-wrap gap-2 mt-auto">
                {["Corporate Law", "Litigation", "General Counsel", "Public Policy"].map(domain => (
          ...
          {/* Collection 3 */}
          <div className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             <Star className="w-10 h-10 text-[#C5A059] mb-8" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Leadership Roles</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-4">
               Explore leaders structured by their specific institutional roles.
             </p>
             <div className="flex flex-wrap gap-2 mt-auto">
                {["Managing Partner", "Chief Legal Officer", "Senior Advocate", "Arbitrator"].map(role => (
                  <span key={role} className="text-[0.6rem] text-[#FFFFF0]/80 px-3 py-1.5 border border-[#333333] bg-[#000000] uppercase tracking-wider">
                    {role}
                  </span>
                ))}
              </div>
          ...
          {/* Collection 4 */}
          <Link href="/juris-index/professionals/women-leaders/organisations" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             <Building2 className="w-10 h-10 text-[#C5A059] mb-8" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Browse by Organisation</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               Discover leaders across Law Firms, Corporate Legal Departments, Independent Practices, and Chambers.
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8">
               Browse Organisations <ArrowRight className="w-4 h-4 transform group-hover:translate-x-2 transition-transform" />
             </div>
          </Link>

          {/* Collection 5 */}
          <Link href="/juris-index/professionals/women-leaders/jurisdictions" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               Geographic discovery across key legal hubs (Delhi, Mumbai, Bengaluru, etc.).
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8">
          ...
          {/* Collection 6 */}
          <Link href="/juris-index/professionals/women-leaders/archive" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               Permanent institutional archive preserving recognition history across all editions.
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8">
             ...
             <div className="flex flex-col lg:flex-row items-center justify-between gap-12 w-full h-full">
               <div className="flex flex-col">
                 ...
                 <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose max-w-lg mb-8">
                   Every recognised leader receives official Institutional Certificates, Digital Recognition Plaques, and Verification Badges.
                 </p>
