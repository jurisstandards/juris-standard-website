...
import { CheckCircle2, MapPin, Building2, Briefcase, Award, ShieldCheck, QrCode } from "lucide-react";
...
const mockProfile = {
  ...
  citation: "Recognised for unparalleled strategic excellence and innovative structuring in cross-border Mergers & Acquisitions, shaping the future of global corporate transactions.",
  overview: "Aarav Mehta is a Senior Partner at Khaitan & Co. with over 20 years of experience advising multinational conglomerates, private equity funds, and sovereign wealth funds on complex, high-value corporate transactions. His leadership in navigating intricate regulatory landscapes has consistently delivered landmark outcomes for his clients.",
  domains: ["Mergers & Acquisitions", "Private Equity", "Corporate Governance"],
  timeline: [
    { year: "2024", title: "Corporate Elite™", detail: "Tier 1 Recognition" },
    { year: "2023", title: "Corporate Elite™", detail: "Tier 1 Recognition" },
    { year: "2022", title: "Corporate Elite™", detail: "Tier 2 Recognition" },
  ],
  verificationId: "CE-2024-AM8923",
  status: "OFFICIALLY RECOGNISED"
};

export default function InstitutionalProfilePage({ params }: { params: { id: string } }) {
  return (
    <main className="min-h-screen bg-[#020202] selection:bg-gold-500/30 flex flex-col font-sans text-neutral-300">
      ...
      <section className="relative w-full pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden border-b border-gold-500/10">
        ...
        <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[1200px] mx-auto relative z-20">
          ...
          <div className="flex items-center gap-3 mb-8">
            <span className="text-[0.6rem] uppercase tracking-[0.3em] text-gold-500 border border-gold-500/30 px-3 py-1 bg-gold-500/5">CORPORATE ELITE™</span>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="w-48 h-64 bg-[#111] border border-white/10 shrink-0 relative overflow-hidden group shadow-2xl">
               ...
               {/* Simulating a high-end corporate portrait with an icon for now */}
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8 text-sm">
                <div className="flex items-center gap-2 text-neutral-400">
                  ...
                  <span className="font-medium tracking-wide">{mockProfile.firm}</span>
                </div>
                <div className="flex items-center gap-2 text-neutral-400">
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[1200px] mx-auto py-16 grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2 flex flex-col gap-16">
          ...
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-white/80 mb-6 flex items-center gap-3">
              <span className="w-6 h-[1px] bg-gold-500/50"></span> RECOGNITION DOMAINS
            </h3>
