...
import { ArrowRight, Search, Briefcase, MapPin, Calendar, Award, ShieldCheck, Building2, Crown } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#020202] selection:bg-gold-500/30 flex flex-col font-sans text-neutral-300">
      ...
      <section className="relative w-full pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden border-b border-gold-500/10">
        <div className="absolute inset-0 z-0">
          {/* Using a ring or corporate icon for background */}
          <div className="absolute right-0 top-0 w-full h-full opacity-30 flex justify-end items-center mix-blend-screen overflow-hidden">
             <img src="/collections/icon_ring.jpg" alt="In-House Counsel" className="w-[800px] h-[800px] object-cover scale-150 translate-x-1/4" style={{ WebkitMaskImage: 'radial-gradient(ellipse at center, black 0%, transparent 60%)' }} />
          </div>
        ...
        <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[2000px] mx-auto relative z-20 flex flex-col lg:flex-row justify-between items-start gap-16">
          <div className="max-w-3xl">
            ...
            {/* Editorial Foreword (Collection 9) */}
            <div className="p-8 bg-black/40 backdrop-blur-xl border border-white/5 shadow-2xl relative">
              ...
              <p className="text-sm md:text-base text-neutral-300 font-light leading-relaxed mb-4">
                "The In-House Counsel Excellence™ index recognises the strategic legal minds driving the world's most dynamic enterprises. This institutional record highlights those who seamlessly blend rigorous legal acumen with commercial foresight, safeguarding their organisations while fueling global growth."
              </p>
          ...
          {/* Quick Verification Portal (Collection 8) */}
          <div className="w-full lg:w-[400px] flex flex-col gap-6">
            <div className="p-8 bg-[#0a0a0a] border border-white/10 rounded-md">
              ...
              <p className="text-xs text-neutral-400 leading-relaxed mb-6">
                Verify the official status and standing of any professional recognised within the In-House Counsel Excellence™ index.
              </p>
              <div className="relative">
                <input 
                  type="text" 
                  placeholder="Enter Recognition ID (e.g., IHC-2024-XXXX)"
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[2000px] mx-auto py-24 flex flex-col gap-24">
        ...
        {/* THE INSTITUTIONAL COLLECTIONS (1-6) */}
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Collection 1: Recognised In-House Counsel */}
            <Link href="/juris-index/professionals/in-house-counsel/professionals" className="group p-8 bg-[#050505] border border-white/5 hover:border-gold-500/30 transition-all duration-500 relative overflow-hidden h-[280px] flex flex-col">
              ...
              <h3 className="font-serif text-xl text-white/90 mb-3">Recognised Counsel</h3>
              <p className="text-[0.65rem] text-neutral-400 uppercase tracking-widest leading-relaxed mb-auto">
                The official annual institutional record of all recognised in-house legal professionals.
              </p>
            ...
            {/* Collection 2: Functional Excellence */}
            <div className="group p-8 bg-gradient-to-b from-[#111] to-[#050505] border border-gold-500/20 hover:border-gold-500/50 transition-all duration-500 relative overflow-hidden h-[280px] flex flex-col shadow-[0_0_30px_rgba(212,175,55,0.05)]">
              ...
              <h3 className="font-serif text-xl text-white/95 mb-3 z-10">Functional Excellence</h3>
              <p className="text-[0.65rem] text-neutral-400 uppercase tracking-widest leading-relaxed mb-4 z-10">
                The primary recognition domains for in-house counsel.
              </p>
              <div className="flex flex-wrap gap-2 mt-auto z-10">
                {["Corporate & Commercial", "Banking & Finance", "ESG & Sustainability", "Data Privacy"].map(domain => (
                  <span key={domain} className="text-[0.55rem] text-white/70 px-2 py-1 border border-white/10 bg-black hover:border-gold-500/40 hover:text-gold-400 cursor-pointer transition-colors uppercase tracking-wider">
                    {domain}
                  </span>
                ))}
              </div>
            ...
            {/* Collection 3: Leadership Levels */}
            <div className="group p-8 bg-gradient-to-b from-[#111] to-[#050505] border border-gold-500/20 hover:border-gold-500/50 transition-all duration-500 relative overflow-hidden h-[280px] flex flex-col shadow-[0_0_30px_rgba(212,175,55,0.05)]">
              <div className="absolute right-0 bottom-0 w-64 h-64 bg-[radial-gradient(circle_at_bottom_right,_rgba(212,175,55,0.1)_0%,_transparent_70%)] pointer-events-none" />
              <Crown className="w-8 h-8 text-gold-500 mb-6 group-hover:text-gold-400 transition-colors" strokeWidth={1} />
              <h3 className="font-serif text-xl text-white/95 mb-3 z-10">Leadership Levels</h3>
              <p className="text-[0.65rem] text-neutral-400 uppercase tracking-widest leading-relaxed mb-4 z-10">
                Recognised professionals structured by their functional hierarchy.
              </p>
              <div className="flex flex-wrap gap-2 mt-auto z-10">
                {["General Counsel", "Group General Counsel", "Chief Legal Officer", "Legal Director"].map(level => (
                  <span key={level} className="text-[0.55rem] text-white/70 px-2 py-1 border border-white/10 bg-black hover:border-gold-500/40 hover:text-gold-400 cursor-pointer transition-colors uppercase tracking-wider">
                    {level}
                  </span>
                ))}
              </div>
            ...
            {/* Collection 4: Browse by Organisation */}
            <Link href="/juris-index/professionals/in-house-counsel/organisations" className="group p-8 bg-[#050505] border border-white/5 hover:border-gold-500/30 transition-all duration-500 relative overflow-hidden h-[280px] flex flex-col">
              <div className="absolute right-0 top-0 w-40 h-40 bg-[radial-gradient(circle_at_top_right,_rgba(212,175,55,0.08)_0%,_transparent_70%)] pointer-events-none" />
              <Building2 className="w-8 h-8 text-gold-500/60 mb-6 group-hover:text-gold-400 transition-colors" strokeWidth={1} />
              <h3 className="font-serif text-xl text-white/90 mb-3">Browse by Organisation</h3>
              <p className="text-[0.65rem] text-neutral-400 uppercase tracking-widest leading-relaxed mb-auto">
                Recognised professionals grouped by enterprise (Public, Private, Start-ups, etc.).
              </p>
              <div className="flex items-center gap-2 text-[0.6rem] uppercase tracking-[0.2em] text-white/40 group-hover:text-gold-400 transition-colors mt-6">
                BROWSE ORGANISATIONS <ArrowRight className="w-3 h-3 transform group-hover:translate-x-1 transition-transform" />
              </div>
            </Link>

            {/* Collection 5: Browse by Jurisdiction */}
            <Link href="/juris-index/professionals/in-house-counsel/jurisdictions" className="group p-8 bg-[#050505] border border-white/5 hover:border-gold-500/30 transition-all duration-500 relative overflow-hidden h-[280px] flex flex-col">
              <div className="absolute right-0 top-0 w-40 h-40 bg-[radial-gradient(circle_at_top_right,_rgba(212,175,55,0.08)_0%,_transparent_70%)] pointer-events-none" />
              ...
              <p className="text-[0.65rem] text-neutral-400 uppercase tracking-widest leading-relaxed mb-auto">
                Filter the In-House Counsel index across specific global jurisdictions and cities.
              </p>
              <div className="flex items-center gap-2 text-[0.6rem] uppercase tracking-[0.2em] text-white/40 group-hover:text-gold-400 transition-colors mt-6">
            ...
            {/* Collection 6: Annual Editions */}
            <Link href="/juris-index/professionals/in-house-counsel/archive" className="group p-8 bg-[#050505] border border-white/5 hover:border-gold-500/30 transition-all duration-500 relative overflow-hidden h-[280px] flex flex-col">
              <div className="absolute right-0 top-0 w-40 h-40 bg-[radial-gradient(circle_at_top_right,_rgba(212,175,55,0.08)_0%,_transparent_70%)] pointer-events-none" />
        ...
        {/* Collection 7: RECOGNITION ASSETS */}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-sm text-neutral-400 font-light leading-relaxed mb-10 max-w-lg">
                Every recognised In-House professional receives a suite of highly prestigious digital and physical assets to signify their official standing within the Juris Standard Index.
              </p>

              <div className="grid grid-cols-2 gap-y-8 gap-x-4">
                {[
                  "Institutional Certificate", "Digital Recognition Plaque", "LinkedIn Recognition Card",
                  "Website Verification Badge", "Email Signature Badge", "Press Kit & QR Verification"
                ].map((asset, idx) => (
