...
import { ArrowRight, Search, Briefcase, Calendar, ShieldCheck, Award, Building2, MapPin, Target } from "lucide-react";
import Link from "next/link";

export default function FutureLeadersPortalPage() {
  return (
    <main className="min-h-screen bg-[#000000] selection:bg-[#C5A059]/30 flex flex-col font-sans text-[#FFFFF0]">
          ...
          <div className="max-w-3xl">
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-[#FFFFF0] leading-[1.05] tracking-wide mb-8 font-light">
              ...
              <span className="font-medium text-[#C5A059]">
                LEADERS<sup className="text-[0.4em] ml-2">™</sup>
              </span>
            </h1>
            ...
            <div className="p-8 bg-[#111111] border border-[#222222] mb-12">
              ...
              <p className="text-sm text-[#FFFFF0]/80 font-light leading-relaxed mb-6">
                "Future Leaders™ identifies lawyers at a formative stage of their professional leadership journey who have demonstrated exceptional potential, influence, and contribution to the legal profession. This is the definitive institutional record of those shaping the profession over the next decade."
              </p>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center bg-[#111111] border border-[#333333] p-1 w-full max-w-xl">
                ...
                <input 
                  type="text" 
                  placeholder="Search by Name, Domain, or Organisation"
          ...
          <div className="w-full lg:w-[400px] shrink-0">
             <div className="bg-[#111111] border border-[#222222] p-10 flex flex-col relative">
               ...
               <p className="text-xs text-[#FFFFF0]/60 leading-relaxed mb-8">
                 Verify the official status and standing of any lawyer recognised within the Future Leaders™ index.
               </p>
      ...
      <section className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[2000px] mx-auto py-32 bg-[#000000]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Collection 1 */}
          <Link href="/juris-index/professionals/future-leaders/directory" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             <Search className="w-10 h-10 text-[#C5A059] mb-8" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Recognised Future Leaders</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               The official annual record of all lawyers recognised under Future Leaders™.
             </p>
          ...
          <div className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-4">
               Future Leaders are recognised within their professional domain.
             </p>
             <div className="flex flex-wrap gap-2 mt-auto">
                {["Corporate Law", "Litigation", "Arbitration", "Technology"].map(domain => (
          ...
          {/* Collection 3 */}
          <div className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             <Target className="w-10 h-10 text-[#C5A059] mb-8" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Career Stage</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-4">
               Recognised by professional stage, avoiding arbitrary age limits.
             </p>
             <div className="flex flex-wrap gap-2 mt-auto">
                {["Principal Associate", "Counsel", "Senior Associate", "Rising GC"].map(stage => (
                  <span key={stage} className="text-[0.6rem] text-[#FFFFF0]/80 px-3 py-1.5 border border-[#333333] bg-[#000000] uppercase tracking-wider">
                    {stage}
                  </span>
                ))}
              </div>
          ...
          {/* Collection 4 */}
          <Link href="/juris-index/professionals/future-leaders/organisations" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               Explore recognised Future Leaders by Law Firm, Independent Practice, or Corporate Legal Department.
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8">
          ...
          {/* Collection 5 */}
          <Link href="/juris-index/professionals/future-leaders/jurisdictions" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               Geographic discovery across key cities like Delhi, Mumbai, Bengaluru, and international hubs.
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8">
          ...
          {/* Collection 6 */}
          <Link href="/juris-index/professionals/future-leaders/archive" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <div className="flex flex-col lg:flex-row items-center justify-between gap-12 w-full h-full">
               <div className="flex flex-col">
                 ...
                 <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose max-w-lg mb-8">
                   Every recognised Future Leader receives official Institutional Certificates, Digital Recognition Plaques, and Verification Badges.
                 </p>
