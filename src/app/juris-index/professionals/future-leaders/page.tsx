    ...
    <main className="min-h-screen bg-[#000000] selection:bg-[#CBAA69]/30 flex flex-col font-sans text-[#FFFFF0] overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[90vh] flex flex-col justify-center bg-[#050505] overflow-hidden pt-24 pb-12 border-b border-[#222222]">
        ...
        <div className="absolute inset-0 w-full h-full z-0 pointer-events-none">
          <img 
            src="/collections/future_leaders_bg.png" 
            alt="Future Leaders" 
          ...
          <div className="flex flex-col max-w-xl lg:max-w-2xl w-full mt-8">
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <span className="text-[0.60rem] uppercase tracking-[0.2em] text-[#CBAA69] font-medium font-sans">
                RECOGNISING THE NEXT GENERATION OF LEGAL LEADERSHIP
              </span>
            </div>
            ...
            <p className="text-neutral-300 text-sm md:text-base max-w-lg mb-10 leading-[1.7] font-light tracking-wide shadow-sm">
              A distinguished record of exceptional young lawyers who are demonstrating outstanding legal ability, leadership potential and a commitment to shaping the future of the profession.
            </p>
      ...
      {/* 2. RECOGNISED FUTURE LEADERS BANDS */}
      <div className="flex flex-col w-full relative z-10 bg-[#000000] pt-8">
        {[
          {
            num: "01",
            title: "FUTURE LEADERS™ 2027",
            subtitle: "THE PRINCIPAL RECORD",
            link: "VIEW COMPLETE RECORD",
            lawyers: [
              { name: "AASTHA MEHRA", type: "Associate", firmName: "AZB & Partners", loc: "Mumbai", badge: "FUTURE LEADERS™\n2027 • RECOGNISED" },
              { name: "VARUN AGRAWAL", type: "Associate", firmName: "Cyril Amarchand\nMangaldas", loc: "New Delhi", badge: "FUTURE LEADERS™\n2027 • RECOGNISED" },
              { name: "ISHITA BHATIA", type: "Senior Associate", firmName: "Shardul Amarchand\nMangaldas", loc: "Bengaluru", badge: "FUTURE LEADERS™\n2027 • RECOGNISED" },
              { name: "ARJUN NARANG", type: "Associate", firmName: "Khaitan & Co", loc: "Mumbai", badge: "FUTURE LEADERS™\n2027 • RECOGNISED" },
              { name: "NEHA VERMA", type: "Associate", firmName: "Link Legal", loc: "New Delhi", badge: "FUTURE LEADERS™\n2027 • RECOGNISED" },
              { name: "RAGHAV SETHI", type: "Associate", firmName: "Trilegal", loc: "Bengaluru", badge: "FUTURE LEADERS™\n2027 • RECOGNISED" },
            ]
          },
          {
            num: "02",
            title: "EMERGING LEADERS",
            subtitle: "THE PROMISING RECORD",
            link: "VIEW RECORD",
            lawyers: [
              { name: "DIYA KAPOOR", type: "Associate", firmName: "JSA", loc: "Mumbai", badge: "EMERGING LEADERS\n2027 • RECOGNISED" },
              { name: "MANAN GUPTA", type: "Associate", firmName: "Shardul Amarchand\nMangaldas", loc: "New Delhi", badge: "EMERGING LEADERS\n2027 • RECOGNISED" },
              { name: "PRANJALI DESAI", type: "Senior Associate", firmName: "AZB & Partners", loc: "Mumbai", badge: "EMERGING LEADERS\n2027 • RECOGNISED" },
              { name: "ADITYA RAO", type: "Associate", firmName: "Cyril Amarchand\nMangaldas", loc: "New Delhi", badge: "EMERGING LEADERS\n2027 • RECOGNISED" },
              { name: "MISHIKA MALHOTRA", type: "Associate", firmName: "Khaitan & Co", loc: "Mumbai", badge: "EMERGING LEADERS\n2027 • RECOGNISED" },
              { name: "SIDDHARTH JAIN", type: "Senior Associate", firmName: "Trilegal", loc: "New Delhi", badge: "EMERGING LEADERS\n2027 • RECOGNISED" },
            ]
          },
          {
            num: "03",
            title: "RISING STARS",
            subtitle: "THE NEXT WAVE",
            link: "VIEW RECORD",
            lawyers: [
              { name: "ANANYA SHARMA", type: "Associate", firmName: "Luthra and Luthra", loc: "New Delhi", badge: "RISING STARS\n2027 • RECOGNISED" },
              { name: "YASH CHORDIA", type: "Associate", firmName: "IndusLaw", loc: "Bengaluru", badge: "RISING STARS\n2027 • RECOGNISED" },
              { name: "MEGHNA IYER", type: "Associate", firmName: "Phoenix Legal", loc: "Mumbai", badge: "RISING STARS\n2027 • RECOGNISED" },
              { name: "KARTIK MADAN", type: "Associate", firmName: "DSK Legal", loc: "New Delhi", badge: "RISING STARS\n2027 • RECOGNISED" },
              { name: "TANISHA BASU", type: "Associate", firmName: "Khaitan & Co", loc: "Kolkata", badge: "RISING STARS\n2027 • RECOGNISED" },
              { name: "VIVEK MENON", type: "Associate", firmName: "AZB & Partners", loc: "Mumbai", badge: "RISING STARS\n2027 • RECOGNISED" },
            ]
          }
        ].map((band, idx) => (
                ...
                {band.lawyers.map((lawyer, fIdx) => (
                  <div key={fIdx} className="w-full flex flex-col border border-[#2a2a2a] bg-[#0a0a0a] hover:border-[#CBAA69]/60 transition-colors duration-200 relative cursor-pointer group/card rounded-[2px] overflow-hidden">
                    ...
                    <div className="p-4 flex flex-col flex-1 relative z-10">
                      ...
                      <span className="text-[0.5rem] text-white/50 leading-tight mb-1 whitespace-pre-line">{lawyer.firmName}</span>
        ...
        <div className="w-full border border-[#CBAA69]/30 rounded-[2px] relative bg-[#050505] flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 flex-1 border-r-0 lg:border-r border-[#CBAA69]/20 gap-y-10 lg:gap-y-0">
              ...
              <div className="flex flex-col px-4 lg:px-6">
                ...
                <div className="flex flex-col gap-3 text-[0.55rem] text-white/50">
                  {["Law Firm", "Chambers", "Independent", "Institution", "Legal Tech", "In-House"].map(t => (
                    <span key={t} className="hover:text-[#CBAA69] cursor-pointer transition-colors">{t}</span>
                  ))}
                </div>
              </div>
              ...
              <div className="flex flex-col px-4 lg:px-6">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-[0.6rem] font-bold tracking-[0.15em] text-[#CBAA69] uppercase">EXPLORE BY JURISDICTION</span>
                </div>
                <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-[0.55rem] text-white/50">
                  {["India", "Bengaluru", "Mumbai", "Hyderabad", "Delhi", "Kolkata", "Chennai", "Global"].map(t => (
                    <span key={t} className="hover:text-[#CBAA69] cursor-pointer transition-colors">{t}</span>
                  ))}
                </div>
              </div>
          ...
          <div className="flex flex-col lg:flex-row w-full pt-8 pb-8 px-4 lg:px-6">
            ...
            <div className="flex flex-col flex-1 lg:border-r border-[#CBAA69]/20 px-4 lg:px-6 mb-8 lg:mb-0">
              <h2 className="text-[0.6rem] font-bold tracking-[0.15em] text-white/50 uppercase mb-2">THE JURIS STANDARD RECORD™</h2>
              <p className="text-[0.55rem] text-white/30 mb-6">A mark of trust. A standard of distinction.</p>
            ...
            {/* Right: Official Digital Recognition */}
