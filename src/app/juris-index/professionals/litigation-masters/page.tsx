...
import { ArrowRight, Search, Briefcase, Calendar, ShieldCheck, Award, Building2, MapPin, Scale } from "lucide-react";
import Link from "next/link";

export default function LitigationMastersPortalPage() {
  return (
    <main className="min-h-screen bg-[#000000] selection:bg-[#C5A059]/30 flex flex-col font-sans text-[#FFFFF0]">
          ...
          <div className="max-w-3xl">
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-[#FFFFF0] leading-[1.05] tracking-wide mb-8 font-light">
              ...
              <span className="font-medium text-[#C5A059]">
                MASTERS<sup className="text-[0.4em] ml-2">™</sup>
              </span>
            </h1>
            ...
            <div className="p-8 bg-[#111111] border border-[#222222] mb-12">
              ...
              <p className="text-sm text-[#FFFFF0]/80 font-light leading-relaxed mb-6">
                "Litigation Masters™ is the definitive institutional record of exceptional advocates. While corporate lawyers are discovered by transactions, litigators are discovered by courts, disputes, and advocacy. This index recognises the strategic minds shaping jurisprudence and resolving complex litigation globally."
              </p>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center bg-[#111111] border border-[#333333] p-1 w-full max-w-xl">
                ...
                <input 
                  type="text" 
                  placeholder="Search by Lawyer, Court, or Domain"
          ...
          <div className="w-full lg:w-[400px] shrink-0">
             <div className="bg-[#111111] border border-[#222222] p-10 flex flex-col relative">
               ...
               <p className="text-xs text-[#FFFFF0]/60 leading-relaxed mb-8">
                 Verify the official status and standing of any advocate recognised within the Litigation Masters™ index.
               </p>
      ...
      <section className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[2000px] mx-auto py-32 bg-[#000000]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Collection 1 */}
          <Link href="/juris-index/professionals/litigation-masters/directory" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             <Search className="w-10 h-10 text-[#C5A059] mb-8" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Recognised Lawyers</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               The official annual institutional record of all lawyers recognised under Litigation Masters™.
             </p>
          ...
          <div className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Recognition Domains</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-4">
               The principal method of browsing recognised litigators by their disputes expertise.
             </p>
             <div className="flex flex-wrap gap-2 mt-auto">
                {["Constitutional Law", "Commercial Litigation", "Arbitration", "White Collar Crime"].map(domain => (
          ...
          {/* Collection 3: BROWSE BY COURT (Unique) */}
          <Link href="/juris-index/professionals/litigation-masters/courts" className="group bg-[#111111] p-12 border border-[#C5A059]/30 hover:border-[#C5A059] transition-colors flex flex-col h-[320px] relative overflow-hidden">
             <div className="absolute top-0 right-0 bg-[#C5A059] text-black text-[0.55rem] font-bold uppercase tracking-widest px-3 py-1">Defining Feature</div>
             <Scale className="w-10 h-10 text-[#C5A059] mb-8 relative z-10" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4 relative z-10">Browse by Court</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto relative z-10">
               Find recognised advocates by the forums in which they principally appear (e.g., Supreme Court, NCLT).
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8 relative z-10">
               Browse Courts <ArrowRight className="w-4 h-4 transform group-hover:translate-x-2 transition-transform" />
             </div>
          </Link>

          {/* Collection 4 */}
          <Link href="/juris-index/professionals/litigation-masters/chambers" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             <Building2 className="w-10 h-10 text-[#C5A059] mb-8" strokeWidth={1} />
             <h3 className="font-serif text-2xl text-[#FFFFF0] mb-4">Chambers & Law Firms</h3>
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               Discover litigators practicing independently, from Senior Advocate Chambers, or Law Firms.
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8">
               Browse Institutions <ArrowRight className="w-4 h-4 transform group-hover:translate-x-2 transition-transform" />
             </div>
          </Link>

          {/* Collection 5 */}
          <Link href="/juris-index/professionals/litigation-masters/jurisdictions" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose mb-auto">
               Geographic discovery across key litigation hubs (Delhi, Mumbai, Chennai, etc.).
             </p>
             <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#C5A059] mt-8">
          ...
          {/* Collection 6 */}
          <Link href="/juris-index/professionals/litigation-masters/archive" className="group bg-[#111111] p-12 border border-[#222222] hover:border-[#C5A059] transition-colors flex flex-col h-[320px]">
             ...
             <div className="flex flex-col lg:flex-row items-center justify-between gap-12 w-full h-full">
               <div className="flex flex-col">
                 ...
                 <p className="text-[0.7rem] text-[#FFFFF0]/60 uppercase tracking-widest leading-loose max-w-lg mb-8">
                   Every recognised Litigator receives official Institutional Certificates, Digital Recognition Plaques, and Verification Badges.
                 </p>
