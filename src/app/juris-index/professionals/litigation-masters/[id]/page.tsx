...
export default function LitigationMastersProfilePage() {
  ...
  if (!record) {
    return (
      <div className="min-h-screen bg-[#020202] text-white flex flex-col items-center justify-center font-sans">
        ...
        <button onClick={() => router.back()} className="text-sm text-white/50 hover:text-white">Return to Litigation Masters</button>
      </div>
    );
  }
  ...
  const handleCopyCitation = () => {
    const citationText = `The Juris Standard. (${record.year || '2027'}). ${record.name} - Litigation Masters™ (${roleName}). ${recognitionId}.`;
      ...
      <div className="relative z-10 flex flex-col w-full">
        ...
        <div className="w-full px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto relative z-10">
          ...
          <div className="flex justify-between items-center mb-16 border-b border-white/[0.05] pb-6">
            <button onClick={() => router.push('/juris-index/professionals/litigation-masters')} className="flex items-center gap-3 text-[0.6rem] uppercase tracking-widest text-white/50 hover:text-[#CBAA69] transition-colors">
              <ArrowLeft className="w-4 h-4" /> Back to Litigation Masters™
            </button>
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-20 items-start mt-8">
            ...
            <div className="flex flex-col flex-1 pt-0 min-w-0">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[0.55rem] tracking-[0.4em] text-white/50 uppercase">Litigation Masters™</span>
              </div>
      ...
      <section className="w-full px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto py-16 flex flex-col gap-12">
        ...
        <div className="w-full border border-[#CBAA69]/30 bg-gradient-to-br from-[#111] to-[#050505] p-8 md:p-12 flex flex-col lg:flex-row gap-12 items-center justify-between shadow-[0_15px_40px_rgba(203,170,105,0.06)] rounded-sm">
           ...
           <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full lg:w-auto flex-1">
             <Link href={`/juris-index/professionals/litigation-masters/${id}/certificate`} className="group flex flex-col items-center justify-center text-center gap-4 p-6 border border-white/10 bg-[#0a0a0a] hover:border-[#CBAA69]/50 hover:bg-[#CBAA69]/5 transition-all">
             ...
             <Link href={`/juris-index/professionals/litigation-masters/${id}/share`} className="group flex flex-col items-center justify-center text-center gap-4 p-6 border border-white/10 bg-[#0a0a0a] hover:border-[#CBAA69]/50 hover:bg-[#CBAA69]/5 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           ...
           <div className="border border-white/[0.05] bg-[#0a0a0a] p-8 flex flex-col group hover:border-[#CBAA69]/30 transition-colors">
              ...
              <p className="text-[0.7rem] text-white/60 mb-6 leading-relaxed font-serif flex-1">
                 Litigation Masters™ recognises exceptional counsel and strategic judgement through a rigorous, independent editorial process.
              </p>
           ...
           <div className="border border-white/[0.05] bg-[#0a0a0a] p-8 flex flex-col group hover:border-[#CBAA69]/30 transition-colors">
              ...
              <div className="border border-white/10 bg-[#050505] p-4 mb-4">
                 <p className="text-[0.55rem] leading-relaxed text-white/60 font-serif">
                   The Juris Standard. ({record.year || '2027'}). {record.name} – Litigation Masters™. {recognitionId}.
                 </p>
              </div>
