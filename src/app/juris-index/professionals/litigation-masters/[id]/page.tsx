...
import { CheckCircle2, MapPin, Building2, Scale, ShieldCheck, QrCode, ArrowRight } from "lucide-react";
import Link from "next/link";

const mockProfile = {
  name: "Vikram Nanda",
  organisation: "Nanda & Associates Chambers",
  primaryCourts: ["Supreme Court of India", "Delhi High Court", "NCLAT"],
  jurisdiction: "New Delhi, India",
  citation: "Recognised for unparalleled advocacy and strategic brilliance in high-stakes appellate litigation before the Supreme Court of India.",
  overview: "Vikram Nanda is a distinguished Senior Advocate known for his formidable courtroom presence and incisive legal strategy. Practising primarily before the Supreme Court of India and the Delhi High Court, he has successfully argued numerous landmark constitutional and commercial matters that have shaped contemporary jurisprudence.",
  domains: ["Constitutional Law", "Commercial Litigation", "White Collar Crime"],
  timeline: [
    { year: "2024", title: "Litigation Masters™", detail: "Recognised" },
    { year: "2023", title: "Litigation Masters™", detail: "Recognised" },
  ],
  verificationId: "LM-2024-VN101"
};

export default function LitigationMastersProfilePage({ params }: { params: { id: string } }) {
  return (
    <main className="min-h-screen bg-[#000000] selection:bg-[#C5A059]/30 flex flex-col font-sans text-[#FFFFF0]">
      ...
      <section className="w-full pt-40 pb-24 border-b border-[#222222] bg-[#000000]">
        <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-4 text-xs font-semibold tracking-widest text-[#C5A059] uppercase mb-12">
            ...
            LITIGATION MASTERS™ • OFFICIAL RECORD
          </div>
            ...
            <div className="flex flex-col flex-grow">
              ...
              <div className="flex flex-col gap-4 text-sm tracking-widest uppercase text-[#FFFFF0]/60 mb-12">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#C5A059] font-semibold">{mockProfile.organisation}</span>
                </div>
                <div className="flex items-center gap-3">
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32 max-w-[1200px] mx-auto py-24 grid grid-cols-1 lg:grid-cols-3 gap-24">
        ...
        <div className="flex flex-col gap-16">
          ...
          {/* Primary Courts Block */}
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C5A059] mb-6">Primary Courts</h3>
            <ul className="flex flex-col gap-4">
              {mockProfile.primaryCourts.map((court, idx) => (
                <li key={idx} className="text-sm text-[#FFFFF0]/70 font-light tracking-wide flex items-center gap-3">
                  <Scale className="w-3 h-3 text-[#C5A059]/50" /> {court}
                </li>
              ))}
            </ul>
          </section>
          ...
          <section className="p-8 bg-[#111111] border border-[#333333]">
            ...
            <p className="text-[0.65rem] uppercase tracking-widest text-[#FFFFF0]/50 leading-loose mb-8">
              Official assets and downloads are strictly available to recognised advocates via the Recognition Centre.
            </p>
